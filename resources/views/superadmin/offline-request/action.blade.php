...
@if ($offlinerequest->is_approved == 0)
    <a class="btn btn-sm small btn btn-success action-btn-fix" href="{{ route('offline.request.status', $offlinerequest->id) }}"
    ...
    <a class="btn btn-sm small btn btn-danger reason action-btn-fix" href="javascript:void(0)"
