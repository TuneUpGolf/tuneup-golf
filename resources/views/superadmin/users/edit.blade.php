...
@section('title', __('Edit Golf Course'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('users.index') }}">{{ __('Admins') }}</a></li>
    <li class="breadcrumb-item">{{ __('Edit Golf Course') }}</li>
@endsection
@section('content')
            ...
            <div class="m-auto col-lg-6 col-md-8 col-xxl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            {{ Form::label('application_fee_percentage', __('Application Fee (%)'), ['class' => 'form-label']) }}
                            {!! Form::text('application_fee_percentage', null, [
                                'class' => 'form-control',
                                ' required',
                                'placeholder' => __('Enter Application Fee (%)'),
                            ]) !!}
                        </div>
