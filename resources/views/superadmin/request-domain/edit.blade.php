            ...
            <div class="col-lg-6 col-md-8 col-xxl-8 m-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <ul>
                                ...
                                <li class="text-danger"> {{ __('If you give incorrect website host,then 404 error will be shown
                                    throughout the
                                    whole
                                    website') }} </li>
                                <li> {{ __('if your website URL is') }} <span class="text-danger">{{ __('https://example.com/') }}</span> {{ __(',then host
                                    will be') }}
                                    <span class="text-danger">{{ __('example.com') }}</span>
                                </li>
                                <li> {{ __('if your website URL is') }} <span class="text-danger">{{ __('https://subdomain.example.com/') }}</span>
                                    {{ __(',then host
                                    will
                                    be') }} <span class="text-danger">{{ __('subdomain.example.com') }}</span> </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            <a href="{{ route('request.domain.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
