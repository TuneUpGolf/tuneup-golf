            ...
            <div class="row">
                @can('manage-lessons')
                    <div class="col-lg-2 col-6">
                        <div class="relative flex flex-col bg-card1  rounded-lg w-96">
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="relative flex flex-col bg-card4  rounded-lg w-96">
                            <div class="p-4 flex flex-col justify-center items-center">
                        ...
                        <div class="relative flex flex-col bg-card1  rounded-lg w-96">
                            <div class="p-4 flex flex-col justify-center items-center">
                                <div class="flex flex-col justify-center items-center text-center">
                                    ...
                                    <p class="font-sans font-thin mb-0">{{ __('InPerson') }}</p>
                                    <span class="font-roboto font-semibold"> {{ __('Completed Lessons') }} </span>
                                </div>
                                <p class="mb-0 font-sans font-thin bg-card-text text-xl"> {{ $inPerson_completed }} </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-6">
                        <div class="relative flex flex-col bg-card4  rounded-lg w-96">
                            <div class="p-4 flex flex-col justify-center items-center">
                                <div class="flex flex-col justify-center items-center">
                                    ...
                                    <p class="font-sans font-thin mb-0">{{ __('Upcoming') }}</p>
                                    <span class="font-roboto font-semibold"> {{ __('InPerson Lessons') }} </span>
                                </div>
                                <p class="mb-0 font-sans font-thin bg-card4-text text-xl">
                                    {{ $inPerson_pending }} </p>
                            </div>
                ...
                @can('manage-students')
                    <div class="col-lg-2 col-6">
                        <div class="relative flex flex-col bg-card2  rounded-lg w-96">
                            <div class="p-4 flex flex-col justify-center items-center">
                                <div class="flex flex-col justify-center items-center">
                                    <div class="mb-6">
                                    ...
                                    <p class="font-roboto font-semibold"> {{ __('Students') }} </p>
                                </div>
                ...
                @if (Auth::user()->type == 'Admin' || Auth::user()->type == 'Instructor')
                    <div class="col-lg-2 col-6">
                        <div class="relative flex flex-col bg-card3  rounded-lg w-96">
                            <div class="p-4 flex flex-col justify-center items-center">
                                <div class="flex flex-col justify-center items-center">
                                    <div class="mb-6">
                                    ...
                                    <p class="font-sans font-thin mb-0">{{ __('Total') }}</p>
                                    <p class="font-roboto font-semibold"> {{ __('Earnings') }} </p>
                                </div>
