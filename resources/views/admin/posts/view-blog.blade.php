        ...
        <section class="article-sec pt">
            <div class="container">
                ...
                <section class="article-image">
                    <img src="{{ isset($blog->photo) ? Storage::url(tenant('id') . '/' . $blog->photo) : asset('assets/images/landingpage-2-image/article-bg.png') }}"
                            ...
                            <div class="article-card-inner">
                                <div class="article-card-image">
                                    <a href="{{ route('view.blog', $oneBlog->slug) }}">
                                        <img src="{{ isset($oneBlog->photo) ? Storage::url(tenant('id') . '/' . $oneBlog->photo) : asset('assets/images/landingpage-2-image/blog-card-img-2.png') }}"
                                            alt="blog-card-image">
                                    </a>
                                </div>
