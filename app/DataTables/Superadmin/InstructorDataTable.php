...
class InstructorDataTable extends DataTable
{
    public function dataTable($query)
    {
        ...
        $data = datatables()
            ...
            ->addColumn('action', function (User $user) {
                return view('superadmin.instructors.action', compact('user'));
            })
    ...
    public function query(User $model)
    {
        if (tenant('id') == null) {
            ...
            return $model->newQuery()->where('type', '=', 'Instructor');
        }
    }
        ...
        return $this->builder()
            ...
            ->parameters([
                "dom" =>  "
                    ...
                    <'dataTable-botton table-btn col-lg-6 col-sm-12'><'dataTable-search tb-search col-lg-3 col-sm-12'f>>
