        ...
        return datatables()
            ...
            ->editColumn('status', function (Category $category) {
                ...
                $status   = '<label class="form-switch">
                             <input class="form-check-input chnageStatus" name="custom-switch-checkbox" ' . $checked . ' data-id="' . $category->id . '" data-url="' . route('category.status', $category->id) . '" type="checkbox">
                             </label>';
                return $status;
            })
