...
class StudentDataTable extends DataTable
{
    ...
    {
        // Get current URL or route
        $currentUrl = url()->current();

        // Define buttons
        $buttons = [];

        // Show buttons only if NOT on "all-chat" page
        if (!str_contains($currentUrl, 'all-chat')) {
            $buttons = [
                [
                    'extend' => 'create',
                    'text' => '<i class="ti ti-plus"></i> Add New Student',
        ...
        return $this->builder()
            ...
            ->parameters([
                "dom" => "
                <'dataTable-top row'
                    <'dataTable-title col-lg-3 col-sm-12 d-none d-sm-block'>
                ...
                >
            ",
                'buttons' => $buttons, // ✅ dynamic based on URL
                "scrollX" => true,
                "responsive" => [
                    "scrollX" => false,
                    "details" => [
