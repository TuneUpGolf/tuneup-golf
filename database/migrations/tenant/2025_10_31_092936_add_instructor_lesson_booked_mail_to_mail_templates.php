...
return new class extends Migration
{
    ...
    public function up()
    {
         DB::table('mail_templates')->insert([
            'mailable' => 'App\\Mail\\Admin\\SlotBookedByInstructorMail',
            'subject' => 'Appointment Confirmation with {{ student_name }}',
            'html_template' => '
    ...
    public function down()
    {
        DB::table('mail_templates')
            ->where('mailable', 'App\\Mail\\Admin\\SlotBookedByInstructorMail')
            ->delete();
    }
};
