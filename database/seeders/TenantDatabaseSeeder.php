...
class TenantDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $settings = [
            ['key' => 'app_name', 'value' => 'TUNEUP-Analyzing Golf'],
        ...
        MailTemplate::firstOrCreate([
            ...
            'subject' => 'Purchase created for {{ name }}',
            'html_template' => '<p>Hello, {{ name }}, a purchase has been created against your lesson purchase, please clear your dues via clicking on the link : {{ link }}.</p>',
            'text_template' => 'Hello, {{ name }}.'
        ]);
        ...
        MailTemplate::firstOrCreate([
            ...
            'html_template' => '<p>Hello, {{ name }}. Welcome to tuneup. You can login in  with your credentials at {{link}} </p>',
            'text_template' => 'Hello, {{ name }}.'
        ]);
