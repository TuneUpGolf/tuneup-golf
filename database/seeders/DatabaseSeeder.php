...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $settings = [
            ...
            ['key' => 'application_fee_percentage', 'value' => 10],
            ['key' => 'apps_setting_enable', 'value' => 'on'],
            ['key' => 'apps_name', 'value' => 'Full Multi Tenancy Laravel'],
            ['key' => 'apps_bold_name', 'value' => 'Admin Saas'],
            ['key' => 'app_detail', 'value' => 'A Full Tenancy Laravel Admin Saas application is a web-based software-as-a-service platform built using the Laravel PHP framework.'],
        ...
        MailTemplate::firstOrCreate([
            ...
            'html_template' => '<p>Hello, {{ name }}. We are excited to welcome you to TuneUp! Our platform is designed to help you streamline your operation, grow your brand, and maximize your earnings. You can login with your credentials at : {{ link }} .</p>',
